...
def build_run_manifest(context: RunContext, config: ClientConfig, status: str = "created") -> Dict[str, Any]:
    ...
    return {
        ...
        "playback": {
            ...
            "initial_quality": config.playback.initial_quality,
            "initial_controller_decision": config.playback.initial_controller_decision,
            "max_buffer_seconds": config.playback.max_buffer_seconds,
            "drain_buffer_sleep_seconds": config.playback.drain_buffer_sleep_seconds,
            "preroll_seconds": config.playback.preroll_seconds,
            "max_media_segments": config.playback.max_media_segments,
        },
        "network_replay": {
            "enabled": config.network_replay.enabled,
