# Codex prompt â€” Phase 4E training smoke + offline validation
...
docs/science/04_neural_abr/_historical/phase4e_training_smoke_plan.md
docs/science/04_neural_abr/phase4e_model_acceptance_gates.md
docs/science/04_neural_abr/phase4e_no_benchmark_policy.md
docs/science/04_neural_abr/_historical/phase4e_training_commands_windows.md
docs/science/04_neural_abr/_historical/phase4e_defense_material_requirements.md
```
...
```text
docs/science/04_neural_abr/_historical/phase4e_training_smoke_report.md
docs/science/04_neural_abr/_historical/phase4e_offline_validation_report.md
docs/science/04_neural_abr/_historical/phase4e_model_selection_notes.md
docs/science/04_neural_abr/_historical/phase4e_artifact_manifest.md
docs/science/04_neural_abr/_historical/phase4e_model_card_draft.md
docs/science/04_neural_abr/_historical/phase4e_defense_talking_points.md
docs/science/04_neural_abr/_historical/phase4e_open_limitations.md
docs/science/04_neural_abr/_historical/phase4e_closure_report.md
```
