# Codex Prompt — Phase 4E.2 Expanded External Corpus + Candidate Readiness Gate
...
```text
Phase 4E.2 — expanded external trace corpus + candidate-readiness gate
```

Already closed:

```text
Phase 4A0 — literature intake and triage
Phase 4A1 — source_cards + evidence_matrix
Phase 4A2 — method_decision
Phase 4B  — state/action/reward/training-data contracts
Phase 4C  — training environment / simulator contract
Phase 4D  — offline NeuralABR-Lite pipeline implementation
Phase 4E  — synthetic training smoke
Phase 4E.1 — external normalized trace smoke
```
...
Project: DashClientModular4 — TFG ABR con IA para streaming DASH.
Branch: main.
...
## 2. Scientific decision inherited from Phase 4A–4B
...
docs/science/04_neural_abr/phase4e2_candidate_readiness_report.md
docs/science/04_neural_abr/phase4e2_model_card.md
docs/science/04_neural_abr/phase4e2_validation_report.md
docs/science/04_neural_abr/phase4e2_defense_talking_points.md
docs/science/04_neural_abr/phase4e2_open_limitations.md
docs/science/04_neural_abr/phase4e2_closure_report.md
```
