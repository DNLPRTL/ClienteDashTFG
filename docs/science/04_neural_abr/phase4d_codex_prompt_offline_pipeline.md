# Codex prompt — Phase 4D offline training pipeline implementation
...
```text
docs/science/04_neural_abr/phase4a2_method_decision_report.md
...
docs/science/04_neural_abr/phase4c_training_environment_report.md
...
docs/science/04_neural_abr/phase4d_offline_pipeline_specs_report.md
docs/science/04_neural_abr/offline_pipeline_architecture_spec.md
docs/science/04_neural_abr/neural_abr_lite_module_plan.md
