...
- Phase 6P is active as pre-validation workspace and evidence hygiene.
- Phase 6A0 validation is not opened yet.
...
| `06_validation/` | Future Phase 6 | not created yet; open only in Phase 6A0. |
