﻿# Codex Prompt â€” Phase 4E.1 External Trace Dataset Smoke
...
```text
docs/science/04_neural_abr/_historical/phase4e1_trace_data_intake_report.md
docs/science/04_neural_abr/phase4e1_phase3_trace_reuse_decision.md
docs/science/04_neural_abr/_historical/phase4e1_external_trace_split_plan.md
...
```text
docs/science/04_neural_abr/_historical/phase4e1_external_trace_smoke_report.md
docs/science/04_neural_abr/_historical/phase4e1_dataset_manifest_summary.md
docs/science/04_neural_abr/phase4e1_external_trace_model_card.md
docs/science/04_neural_abr/_historical/phase4e1_external_trace_validation_report.md
docs/science/04_neural_abr/_historical/phase4e1_defense_talking_points.md
docs/science/04_neural_abr/_historical/phase4e1_open_limitations.md
docs/science/04_neural_abr/_historical/phase4e1_closure_report.md
```
