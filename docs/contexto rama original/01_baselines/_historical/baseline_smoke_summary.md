...
Smoke evidence is carried into Phase 2 closure as integration validation only. See `../_historical/phase2_test_validation_summary.md` and `../phase2_academic_validity_statement.md`.
