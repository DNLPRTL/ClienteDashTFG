...
| `feedback_neural_fallback_reason` | `segment_telemetry.csv` | `core.controller.neural_abr_lite.NeuralAbrLiteController.get_last_decision_telemetry` | reason label | After controller decision. | debug/test-only; runtime-only | No | Fail-closed reason label. |
