...
Phase 6A0 no esta abierta todavia.
...
3. No ejecutar benchmark, generar graficas, crear rankings, declarar ganadores ni afirmar mejora de QoE en Phase 6P.
4. No reentrenar NeuralABR-Lite ni cambiar `qoe_linear_v1` / `reward_n` en Phase 6P.
