...
Guia permanente de trabajo para `ClienteDashTFG`.
...
Repo recomendado dentro de WSL: ~/TFG/ClienteDashTFG
...
`~/TFG/ClienteDashTFG`, activara `~/venvs/rocm721` y comprobara PyTorch:
