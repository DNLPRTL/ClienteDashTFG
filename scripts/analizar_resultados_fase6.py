...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    package = analizar_paquete_fase6(args.package_root, generate_plots=not args.no_plots)
    verification = verificar_paquete_fase6(args.package_root, require_plots=not args.no_plots, write_artifacts=True)
