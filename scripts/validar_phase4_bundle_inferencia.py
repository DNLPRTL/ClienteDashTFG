...
DEFAULT_OUTPUT_DIR = TFG_ROOT / "runs_trazas" / "phase4" / "phase4F_validacion_bundle_inferencia"


def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Valida el bundle de inferencia NeuralABR-Lite y ejecuta una prueba offline de inferencia."
    )
