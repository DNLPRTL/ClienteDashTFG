...
def main() -> int:
        ...
        rows.append(
            {
                ...
                "harmful": mode.get("harmful_intervention_rate"),
                "d_reward": mode.get("intervention_reward_delta_mean"),
                "d_rebuffer": mode.get("intervention_rebuffer_delta_mean"),
                "fix_over": mode.get("over_aggressive_fix_rate"),
                "regress_over": mode.get("over_aggressive_regression_rate"),
    ...
    for row in rows:
        print(
            ...
            "useful=", row["useful"],
            "harmful=", row["harmful"],
            "d_reward=", row["d_reward"],
            "d_rebuffer=", row["d_rebuffer"],
            "fix_over=", row["fix_over"],
            "regress_over=", row["regress_over"],
