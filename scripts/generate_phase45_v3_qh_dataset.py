...
from core.phase45_v3.dataset import (
    build_default_phase45_v3_trace_path_rewrites,
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Construye el dataset Phase 4-5 v3 con entorno closed-loop y targets Q_H(s,a)."
    )
    ...
    output_dir = args.output_dir or DEFAULT_OUTPUT_ROOT / "qh_closed_loop_{0}".format(args.profile)
